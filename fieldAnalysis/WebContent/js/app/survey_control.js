...
function getViewData(view) {
	...
	if(view.sId != "-1") {
		...
		if(!questions) {	
			...
			getQuestionList(view.sId, view.lang, view.qId, view.groupQuestionId, undefined, setGroupList, view, undefined, undefined, undefined, undefined);
		} else {
		...
		setSurveyViewQuestions(undefined, undefined, undefined, undefined, undefined, undefined, undefined);
	}
...
function surveyChangeEvent(sId) {
	...
	if(!languages) {
		...
		if(!questions) {
			getQuestionList(sId, languages[0].name, "-1", "-1", undefined, setGroupList, undefined, undefined, undefined, undefined, undefined);	// Default language to the first in the list
		} else {
			setSurveyViewQuestions(questions, undefined, undefined, undefined, undefined, undefined, undefined);
			if(setGroupList) {
...
function languageChangeEvent() {
	...
	if(!qList) {
		getQuestionList(sId, language, "-1", "-1", undefined, setGroupList, undefined, undefined, undefined, undefined, undefined);
	} else {
		setSurveyViewQuestions(qList, undefined, undefined, undefined, undefined, undefined, undefined);
		if(setGroupList) {
