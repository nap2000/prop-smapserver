define({
    ...
    "m_billing": "Billing",
    "m_privacy": "Privacy",
    "m_dsar": "Data Subject Access Request (DSAR)",
    "m_rtbf": "Right to be Forgotten",
    "dsar_desc": "Export all personal data held for a data subject as an XLSX file, including edit history and deleted records.",
    "rtbf_desc": "Replace all personal data (PII fields) for a data subject with [REDACTED] across all surveys and all versions including edit history. The submission record is kept but personal identifiers are permanently overwritten and cannot be recovered.",
    "rtbf_confirm": "Replace all PII fields with [REDACTED] for \"%s1\", including edit history? This cannot be undone.",
    "rtbf_done": "%s1 submission(s) redacted for \"%s2\".",
    "rtbf_none": "No submissions found for \"%s1\".",
    "rtbf_searching": "Searching...",
    "rtbf_no_results": "No matching records found.",
    "rtbf_select_prompt": "Review the records below and select those to redact:",
    ...
    "c_always": "always",
    "c_nobody": "nobody",
    "c_not_in_a_process": "Not part of a process",
    "c_diagram": "Diagram",
    "c_stage": "Stage",
    "c_when": "When",
    "c_assigned_to": "Assigned to",
    "c_who": "Who that is",
    "c_who_does_what": "Who does what",
    "c_channel": "Channel",
    "c_closed": "Closed",
    ...
    "c_2fa": "Two Factor Authentication",
    "c_2fa_scan": "Scan this with your authenticator app, then enter the code it shows.",
    "c_2fa_manual": "Or type this key into the app",
    "c_2fa_code": "Authentication code",
    "c_2fa_enable": "Turn on",
    "c_2fa_remove": "Turn off",
    "c_2fa_remove_help": "Enter a current code to turn two factor authentication off.",
    "c_2fa_on": "Two factor authentication is turned on",
    "c_2fa_off": "Two factor authentication is turned off",
    "c_2fa_reset": "Turn off two factor authentication for this user",
    ...
    "c_tok_never": "Never",
    "c_tok_revoke": "Revoke",
    "c_tok_revoked": "Revoked",
    "c_tok_once": "Copy this now. It is not stored and will not be shown again.",
    "c_tok_qr_once": "Scan this now. It is not stored and cannot be shown again - if it is lost, create another.",
    ...
    "c_charts": "Charts",
    "c_maps": "Maps",
    "c_offline_maps": "Offline Maps",
    "c_offline_map": "Offline Map",
    ...
    "c_add": "Add",
    "c_not_loaded": "Not loaded",
    "c_not_loaded_tt": "This CSV file has not been loaded into a data table and cannot be used by pulldata, lookup or search. Re-upload the file to load it.",
    "c_create": "Create",
    "c_generate": "Generate",
    ...
    "msg_add_offline_map": "Add Offline Map",
    "msg_offline_map_del": "Delete this offline map layer?",
    "msg_offline_map_file": "Select an mbtiles file. Leave empty to keep the current file.",
    "msg_offline_map_project": "Everybody with access to a selected project gets this layer.",
    "c_devices": "Devices",
    "msg_offline_map_uploading": "Uploading",
    ...
    "msg_one_f2": "A survey must be selected",
    ...
    "ed_ls": "Linked Survey",
    "ed_ro": "Read Only",
    "ed_pii": "PII (Personal Data)",
    "ed_pii_none": "Not Personal Data",
    "ed_pii_pii": "Personal Data",
    "ed_pii_anonymise": "Anonymise on Submit",
    "ed_ls_add": "Add link",
    "ed_l": "Linked",
    "ed_nl": "Not Linked",
    ...
    "ed_turnstile": "Enable Cloudflare Turnstile anti-bot protection for public form URL",
    ...
    "ed_pulldata": "Look up data",
    "ed_pd_disabled": "The calculation must be empty or contain a single pulldata() or lookup() function to use this tool",
    "ed_pd_return": "Column to retrieve",
    "ed_pd_repeat": "Look up repeating data",
    "ed_pd_index": "Multiple matches",
    "ed_pd_index_n": "Index",
    "ed_pd_index_v": "Index (position)",
    "ed_pd_sum": "Sum",
    "ed_pd_mean": "Mean",
    "ed_pd_min": "Minimum",
    "ed_pd_max": "Maximum",
    "ed_pd_count": "Count",
    "ed_pd_list": "List",
    "ed_pd_exact": "(exact match)",
    "msg_pd_return": "You must select the column to retrieve",
    "msg_pd_filter": "You must select a filter column",
    "contains": "contains",
    ...
    "u_mcp": "MCP Server",
    "m_mcp_access": "AI access",
    "mcp_apps": "Applications with access",
    "mcp_apps_desc": "AI applications you have allowed to use Smap as you. They can never do more than your own account allows.",
    "mcp_none": "You have not given any application access.",
    "mcp_app": "Application",
    "mcp_permissions": "Permissions",
    "mcp_first": "First authorised",
    "mcp_last_used": "Last used",
    "mcp_withdraw": "Withdraw",
    "mcp_withdraw_confirm": "Withdraw access for this application? It will stop working immediately and will have to ask again.",
    "mcp_withdrawn": "Access withdrawn.",
    "mcp_self_registered": "registered itself",
    "mcp_never": "never",
    "mcp_token": "Token for a script",
    "mcp_token_desc": "For something with no browser to authorise with, such as a scheduled job. The value is shown once and cannot be recovered.",
    "mcp_token_name": "What is it for",
    ...
    "u_show_2fa": "Show users with two factor",
    "u_add": "Add User",
    "u_del": "Delete User",
    ...
    "u_ft_om": "Manage offline map layers on the server",
    "u_ft_om_h": "Offline map layers are uploaded on the shared resources page and assigned to users. The device downloads them and cannot add or delete layers itself.",
    ...
    "msg_no_org_sel": "No organisation was selected",
    "msg_no_ent_sel": "No enterprise was selected",
    "u_no_org_target": "There is no organisation to move to.  Choose an enterprise that has an organisation you can move to",
    ...
    "u_eoi": "Enable Opt In",
    "u_enable_redact": "Enable Redactions",
    "admin": "Administrator",
    "analyst": "Analyst",
    ...
    "n_ar": "Reference survey %s1 for %s2.",
    ...
    "mo_ss": "This survey form has been successfully submitted",
    ...
    "mo_ms_count_pre": "You have submitted this survey",
    "mo_ms_count_post": "time(s)",
    "mo_ms_again": "Submit Again",
    ...
    "u_dh_unmapped": "%s1 of the %s2 values in this data set are not mapped. Anything left unmapped is simply never sent.",
    "u_dh_all_mapped": "All %s1 values in this data set are mapped.",
    ...
    "c_decision": "Decision",
    "c_reminder": "Reminder",
    "c_step_type": "Step type",
    "c_standalone": "(standalone)",
    "c_label": "Label",
    "c_create_step": "Create Step",
    "c_assign_type": "Assign type",
    "c_unassigned": "Unassigned",
    "c_assign_to": "Assign to",
    "c_to_emails": "To (emails)",
    "c_message": "Message",
    "c_to_phone": "To (phone)",
    "c_list": "List",
    "c_update_or_insert": "Update or Insert",
    "c_match_sp_column": "Match SP column",
    "c_match_survey_field": "Match survey field",
    "c_column_map": "Column map",
    "c_sp_column": "SP column",
    "c_survey_field": "Survey field",
    "c_bundle_notification": "Bundle notification",
    "c_no_condition": "No condition (always run)",
    "c_no_data": "No data",
    "c_add_step_from_node": "Add step from this node",
    "c_add_step": "Add step",
    "c_advanced": "Advanced",
    "c_delete_step": "Delete step",
    "c_delete": "Delete",
    ...
    "c_refresh": "Refresh",
    "ops_title": "Operations Monitor",
    "ops_open_cases": "Open cases",
    "ops_open_tasks": "Open tasks",
    "ops_unassigned_cases": "Unassigned cases",
    "ops_tasks_in_progress": "Tasks in progress",
    "ops_tasks_overdue": "Tasks overdue",
    "ops_stale_items": "Stale items",
    "ops_open_alerts": "Open alerts",
    "ops_submissions_7d": "Submissions (7 days)",
    "ops_units": "Units (roles)",
    "ops_role": "Role",
    "ops_overdue_pct": "Overdue %",
    "ops_alerts": "Open alerts",
    "ops_backlog": "Case backlog",
    "ops_chart_line": "Backlog trend",
    "ops_chart_bar": "Opened vs closed",
    "ops_expand": "Expand / collapse",
    "ops_net_backlog": "Net backlog",
    "ops_opened": "Opened",
    "ops_closed": "Closed",
    "ops_no_units": "No units with open work",
    "ops_by_unit": "Break down by unit",
    "ops_by_bundle": "Break down by bundle",
    "ops_bundle": "Bundle",
    "ops_bundles": "Bundles",
    "ops_stale": "Stale",
    "ops_no_bundles": "No bundles with open cases",
