define({
	...
	"msg_restore_started": "Restoration of the survey data has started.  Press refresh to see progress.  This process may take minutes if file to be retrieved from of site storage",
